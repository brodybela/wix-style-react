...
import ExampleStatsWidgetWithPersents from './ExampleStatsWidgetWithPersents';
import ExampleStatsWidgetWithPersentsRaw from '!raw-loader!./ExampleStatsWidgetWithPersents';
  ...
  .add('Stats Widget', () => (
    <TabbedView tabs={['Usage', 'Testkit']}>
      <div>
        ...
        <CodeExample title="Stats widget example with persents" code={ExampleStatsWidgetWithPersentsRaw}>
          <ExampleStatsWidgetWithPersents/>
        </CodeExample>
